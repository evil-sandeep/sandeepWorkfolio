...
export default function AboutMe(props) {
  ...
  const SCREEN_CONSTSANTS = {
    description:
      "Full stack web  developer with background knowledge of MERN stacks with redux, along with a knack of building applications with utmost efficiency.My passion for software development drives me to continuously learn and adapt to new technologies, ensuring efficient and innovative solutions for complex challenges.",
    highlights: {
      bullets: [
