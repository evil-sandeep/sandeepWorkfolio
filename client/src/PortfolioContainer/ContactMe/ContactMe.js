    ...
    <div className="main-container" id={props.id || ""}>
      ...
      <div className="central-form">
        <div className="col">
          ...
          <a href="https://api.whatsapp.com/send?phone=919078996315" target="_blank" rel="noreferrer">
        ...
        <div className="back-form">
          <div className="img-back">
            ...
            <img src={imgBack} alt="imge not found" />
          </div>
          <form onSubmit={submitForm}>
            ...
            <div className="send-btn">
              <button type="submit">
                ...
                {bool ? (
                  <b className="load">
                    <img src={load1} alt="imge not responding" />
                  </b>
                ) : (
                  ""
                )}
